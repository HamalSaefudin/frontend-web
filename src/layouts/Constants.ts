import { LayoutDashboardIcon, PackageIcon, UsersIcon, FileTextIcon, ClipboardCheckIcon, WalletIcon, MapPinIcon } from "lucide-react";
...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/master-locator", label: "Master Lokasi Warehouse", icon: MapPinIcon },
    ],
  },
] as const;