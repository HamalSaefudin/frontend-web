...
import type { Lead } from "@frontend/shared";
import type {
  CellContext,
  ColumnDef,
  HeaderContext,
...
function SortableHeader({
  ...
  label: string;
  column: HeaderContext<Lead, unknown>["column"];
}) {
        ...
        {form && (
          <div className="flex flex-col gap-4">
            ...
            <SelectField
              ...
              onChange={(val) =>
                setForm({ ...form, status: val?.value as Lead["status"] })
              }
            />
            <DatePicker
              label="Created At"
              ...
              onChange={(date) =>
                setForm({
                  ...form,
                  createdAt: date ? date.toISOString() : form.createdAt,
                })
              }
            />
