import { AppModal, LoadingOverlay, Button, InputField, SelectField, type SelectOption, Switch, DataTable } from '@frontend/ui'
...
export function MasterCoaForm({
  ...
  const rawWatchedTransactions = watch('transactions');
  const watchedTransactions: MasterCoaCreateFormData['transactions'] = useMemo(
    () => rawWatchedTransactions ?? [],
    [rawWatchedTransactions],
  );
