import type { MasterKas } from '@frontend/shared/types/types-master-kas.ts';
import { AppModal, Button, InputField, LoadingOverlay, SelectField, type SelectOption, Switch } from "@frontend/ui";
